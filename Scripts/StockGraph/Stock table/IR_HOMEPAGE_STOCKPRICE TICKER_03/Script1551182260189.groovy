...
//Verifying stock widget present or not
boolean result=WebUI.verifyElementPresent(findTestObject("Object Repository/Stock price widget Objects/Stock Price values object/Stock price values"), 5);
...
System.out.println("Price appreciation"+comparisonvalue1);
...
DecimalFormat df=new DecimalFormat("##.##");
String comparisonvalue2=df.format(comparisonvalue);
System.out.println(comparisonvalue2);
//Assert.assertEquals(firstWord, comparisonvalue1)
System.out.println("Price depreciation"+comparisonvalue2);
