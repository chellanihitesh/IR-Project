...
WebUI.scrollToElement(findTestObject('Home Page/Page_Investor Relations/li_Presentations'), 5)

WebUI.click(findTestObject('Home Page/Page_Investor Relations/li_Presentations'))
